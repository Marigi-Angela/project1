...
function getPro(){
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        $farmer_id = $row_products['farmer_id'];

        $get_farmer = "select * from farmers where farmer_id='$farmer_id'";

        $run_farmer = mysqli_query($db,$get_farmer);
        ...
        <div class='col-md-4 col-sm-6 single'>
            ...
            <div class='product'>
                ...
                <center>
                    ...
                    <p class='btn btn-primary'> $farmer_title </p>
