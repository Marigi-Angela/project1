    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="dev-table-filter" data-filters="#dev-farmer" data-action="filter" placeholder="Filter Manufacturer">
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="dev-farmer"><!-- nav nav-pills nav-stacked category-menu Begin -->
                
                <?php 
                
                $get_farmer = "select * from farmers where farmer_top='yes'";
                $run_farmer = mysqli_query($con,$get_farmer);

                while($row_farmer=mysqli_fetch_array($run_farmer)){

                    $farmer_id = $row_farmer['farmer_id'];
                    $farmer_title = $row_farmer['farmer_title'];
                    $farmer_image = $row_farmer['farmer_image'];

                    if($farmer_image == ""){

                    }else{

                        $farmer_image = "<img src='admin_area/other_images/$farmer_image' width='20px'>&nbsp;";
                    ...
                    <li style='background:#dddddd' class='checkbox checkbox-primary'>
                        ...
                        <a>
                            ...
                            <label>
                                ...
                                if(isset($aMan[$farmer_id])){
                                    echo "checked='checked'";
                                }
                                
                                echo " value='$farmer_id' type='checkbox' class='get_farmer' name='farmer'>
                ...
                $get_farmer = "select * from farmers where farmer_top='no'";
                $run_farmer = mysqli_query($con,$get_farmer);
